...
When('User enters UID field {string}', {timeout: 60 * 1000} , async function (string) {
  ...
  When('User enters password {string}', {timeout: 60 * 1000} , async function (string) {
    ...
    When('User clicks on Modif Profile  Icone', {timeout: 60 * 1000} , async function () {
      await element(By.xpath("(//button[@class='mat-focus-indicator mat-fab mat-button-base mat-accent'])[1]")).click();
    ...
    When('User enters mobile {string}', {timeout: 60 * 1000} , async function (string) {
      // Write code here that turns the phrase above into concrete actions
      
     var mail =  element(By.name("emailid"))
     mail.clear();
      console.log("mail");

      await browser.sleep(10000)//
      await element(By.name("emailid")).sendKeys(string);
      await browser.sleep(10000)
      });
      
    
    Then('User clicks on Enregistrer button', {timeout: 60 * 1000} , async function () {
      await element(By.xpath("//button[@class='mat-focus-indicator text-white font-bold px-4 rounded mat-raised-button mat-button-base mat-accent']")).click();
    ...
    When('User enters recherche {string}', {timeout: 60 * 1000} , async function (string) {
      // Write code here that turns the phrase above into concrete actions
      await element(By.xpath("/html[1]/body[1]/app-root[1]/layout[1]/dense-layout[1]/div[1]/div[2]/app-profile[1]/div[1]/div[1]/div[1]/table[1]/tr[1]/td[1]/app-userlist[1]/div[1]/div[1]/div[2]/mat-form-field[1]/div[1]/div[1]/div[1]/input[1]")).sendKeys(string);
      console.log("////////////////////");
      await browser.sleep(10000)
      });
    ...
    When('User clicks on Modifier Icone', {timeout: 60 * 1000} , async function () {
      await element(By.xpath("/html[1]/body[1]/app-root[1]/layout[1]/dense-layout[1]/div[1]/div[2]/app-profile[1]/div[1]/div[1]/div[1]/table[1]/tr[1]/td[1]/app-userlist[1]/div[1]/div[3]/div[1]/table[1]/tbody[1]/tr[1]/td[8]/button[1]")).click();
...
// 
    ...
    When('user do the Modification', {timeout: 60 * 1000} , async function  (string) {
      var prenom =  element(By.name("firstName"))
     prenom.clear();
      console.log("firstName");

      await browser.sleep(10000)//
      await element(By.name("firstName")).sendKeys(string);
      await browser.sleep(10000)
    });
